...
--
-- CHANGELOG v2.3.0 (2026-02-16):
-- - Added project information fields to projects table (ORDER_156)
--   * description: Project description (概要)
--   * purpose: Project purpose (目的)
...
CREATE TABLE IF NOT EXISTS projects (
    ...
    description TEXT,                             -- Project description (概要)
    purpose TEXT,                                 -- Project purpose (目的)
    metadata TEXT,                                -- Project metadata (JSON: tech_stack, repo_url, etc.)
